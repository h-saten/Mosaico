...
docker build "$dir/" --tag acrmosaico.azurecr.io/aks-runner-mosaico:$updated_semver

docker tag acrmosaico.azurecr.io/aks-runner-mosaico:$updated_semver acrmosaico.azurecr.io/aks-runner-mosaico:latest

docker push acrmosaico.azurecr.io/aks-runner-mosaico:$updated_semver

docker push acrmosaico.azurecr.io/aks-runner-mosaico:latest

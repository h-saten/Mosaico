...
docker build "$dir/" --tag acrmosaico.azurecr.io/aks-runner-mosaico-dev:$updated_semver

docker tag acrmosaico.azurecr.io/aks-runner-mosaico-dev:$updated_semver acrmosaico.azurecr.io/aks-runner-mosaico-dev:latest

docker push acrmosaico.azurecr.io/aks-runner-mosaico-dev:$updated_semver

docker push acrmosaico.azurecr.io/aks-runner-mosaico-dev:latest

...
docker build "$dir/" --tag acrmosaico.azurecr.io/aks-runner-mosaico-prod:$updated_semver

docker tag acrmosaico.azurecr.io/aks-runner-mosaico-prod:$updated_semver acrmosaico.azurecr.io/aks-runner-mosaico-prod:latest

docker push acrmosaico.azurecr.io/aks-runner-mosaico-prod:$updated_semver

docker push acrmosaico.azurecr.io/aks-runner-mosaico-prod:latest

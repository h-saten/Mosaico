...
resource "azurerm_kubernetes_cluster" "k8s" {
  ...
  default_node_pool {
    ...
    vnet_subnet_id        = var.virtual_nodes_subnet_id
  }
...
#   ]
#   scope = "/subscriptions/${var.subscription_id}/resourceGroups/MC_rg-mosaico-prod_aks-mosaico-prod_westeurope"
...
resource "azurerm_role_assignment" "vmss_managed_id_operator" {
  ...
  scope                = "/subscriptions/${var.subscription_id}/resourceGroups/${azurerm_kubernetes_cluster.k8s.node_resource_group}/providers/Microsoft.Compute/virtualMachineScaleSets/aks-system-67595801-vmss"  #string to vmss - MC_rg-XXXXXXX_westeurope/providers/microsoft.compute/aks-system-XXXX-vmss
...
resource "azurerm_role_assignment" "vmss_vm_contributor" {
  ...
  scope                = "/subscriptions/${var.subscription_id}/resourceGroups/${azurerm_kubernetes_cluster.k8s.node_resource_group}/providers/Microsoft.Compute/virtualMachineScaleSets/aks-system-67595801-vmss" #UPDATE THAT MANUALLY BECAUSE IT IS DYNAMIC NAME 

...
resource "azurerm_kubernetes_cluster" "k8s" {
  ...
  default_node_pool {
    ...
    max_pods              = 30 #this is minimal value
...
resource "azurerm_role_assignment" "vmss_managed_id_operator" {
  ...
  scope                = "/subscriptions/${var.subscription_id}/resourceGroups/${azurerm_kubernetes_cluster.k8s.node_resource_group}"  #string to vmss - MC_rg-XXXXXXX_westeurope/providers/microsoft.compute/aks-system-XXXX-vmss
...
resource "azurerm_role_assignment" "vmss_vm_contributor" {
  ...
  scope                = "/subscriptions/${var.subscription_id}/resourceGroups/${azurerm_kubernetes_cluster.k8s.node_resource_group}" #UPDATE THAT MANUALLY BECAUSE IT IS DYNAMIC NAME 
...
#     azurerm_kubernetes_cluster.k8s
#   ]
#   scope                = "/subscriptions/${var.subscription_id}/resourceGroups/${azurerm_kubernetes_cluster.k8s.node_resource_group}/providers/Microsoft.Compute/virtualMachineScaleSets/aks-system-10032104-vmss"  #string to vmss - MC_rg-XXXXXXX_westeurope/providers/microsoft.compute/aks-system-XXXX-vmss
#   role_definition_name = "Managed Identity Operator"
#   principal_id         = azurerm_kubernetes_cluster.k8s.kubelet_identity[0].object_id
# }
...
#     azurerm_kubernetes_cluster.k8s
#   ]
#   scope                = "/subscriptions/${var.subscription_id}/resourceGroups/${azurerm_kubernetes_cluster.k8s.node_resource_group}/providers/Microsoft.Compute/virtualMachineScaleSets/aks-system-10032104-vmss" #UPDATE THAT MANUALLY BECAUSE IT IS DYNAMIC NAME 
#   role_definition_name = "Virtual Machine Contributor"
#   principal_id         = azurerm_kubernetes_cluster.k8s.kubelet_identity[0].object_id
# } 
#changed issue with getting vmss ID
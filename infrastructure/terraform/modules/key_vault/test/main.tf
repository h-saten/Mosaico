...
resource "azurerm_key_vault" "key_vault" {
  ...
  network_acls {
    virtual_network_subnet_ids = [var.vnet-vpnhub-shared_default, var.vnet-mosaico-test_snet_default, var.vnet-vpnhub-shared_gateway_subnet, var.vnet-mosaico-test_snet_aks_virtual_nodes, var.vnet-mosaico-test_snet_aks] #v1net-mosaico-dev_snet_default

...
@Component({
  selector: 'app-edit-page-colors',
  templateUrl: './edit-page-colors.component.html',
  styleUrls: ['./edit-page-colors.component.scss']
})
export class EditPageColorsComponent implements OnInit {

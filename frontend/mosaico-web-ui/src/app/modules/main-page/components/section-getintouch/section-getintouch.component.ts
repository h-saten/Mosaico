...
@Component({
  selector: 'app-section-getintouch',
  templateUrl: './section-getintouch.component.html',
  styleUrls: ['./section-getintouch.component.scss']
})
export class SectionGetintouchComponent implements OnInit, OnDestroy {

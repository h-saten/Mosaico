export const environment = {
    production: true,
    gatewayUrl: "https://api.mosaico.dev",
    relayUrl: 'https://api.mosaico.dev/relay',
    moralis: {
        "appId": "w6fHIyK9s9ge6F06yr3pgEnAVptFSnnF6fsgqFlF",
        "serverUrl": "https://smuqrjrhuh8b.usemoralis.com:2053/server"
    },
    appVersion: "0.0.1",
    transak: {

...
namespace Mosaico.Persistence.SqlServer.Migrations.Project
{
    ...
    [Migration("20220721130035_AddedPageReviews")]
    partial class AddedPageReviews
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Affiliation.Partner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid>("ProjectAffiliationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Affiliation.PartnerTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("EstimatedReward")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("PurchasedTokens")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("TransactionCorrelationId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PartnerTransactions", "prj");
                });

            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Affiliation.ProjectAffiliation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("EverybodyCanParticipate")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("PartnerShouldBeInvestor")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("ProjectAffiliations", "prj");
                });

            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Affiliation.UserAffiliation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserAffiliations", "prj");
                });

            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Affiliation.UserAffiliationReference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ReferencedUserId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("UserAffiliationReferences", "prj");
                });

            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.AirdropCampaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("CountAsPurchase")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("TokensPerParticipant")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("AirdropCampaigns", "prj");
                });

            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.AirdropParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("AirdropCampaignId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("ClaimedTokenAmount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("AirdropCampaignId");

                    b.HasIndex("Email", "AirdropCampaignId")
                        .IsUnique()
                        .HasFilter("[Email] IS NOT NULL");

                    b.ToTable("AirdropParticipants", "prj");
                });
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.PaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("0a26d7fc-3323-483f-b2f3-a30e033af7e2"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Key = "BANK_TRANSFER",
                            ModifiedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Title = "Bank Transfer",
                        ...
                        new
                        {
                            Id = new Guid("614005f3-b356-45e8-96a2-b6e2a880240a"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Key = "BINANCE",
                            ModifiedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Title = "Binance",
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Project", b =>
                {
                    ...
                    b.Property<bool>("IsAccessibleViaLink")
                        .HasColumnType("bit");

                    b.Property<bool>("IsBlockedForEditing")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsVisibleOnLanding")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.ProjectInvestor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProjectInvestors", "prj");
                });
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.ProjectVisitors", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProjectVisitors");
                });

            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Ratings.ProjectLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Stage", b =>
                {
                    ...
                    b.Property<bool>("AllowRedeployment")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.StagePurchaseLimit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("StagePurchaseLimits", "prj");
                });
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.TokenPage.PageIntroVideos", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("ShowLocalVideo")
                        .HasColumnType("bit");

                    b.Property<long>("Version")
                        .HasColumnType("bigint");

                    b.Property<string>("VideoExternalLink")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PageIntroVideos");
                });

            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.TokenPage.PagePartners", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PagePartners", "prj");
                });

            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.TokenPage.PageReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.TokenPage.Script", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Affiliation.Partner", b =>
                {
                    b.HasOne("Mosaico.Domain.ProjectManagement.Entities.Affiliation.ProjectAffiliation", "ProjectAffiliation")
                        .WithMany("Partners")
                        .HasForeignKey("ProjectAffiliationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mosaico.Domain.ProjectManagement.Entities.Affiliation.UserAffiliation", "UserAffiliation")
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Affiliation.PartnerTransaction", b =>
                {
                    b.HasOne("Mosaico.Domain.ProjectManagement.Entities.Affiliation.Partner", "Partner")
                        .WithMany("PartnerTransactions")
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Affiliation.ProjectAffiliation", b =>
                {
                    b.HasOne("Mosaico.Domain.ProjectManagement.Entities.Project", "Project")
                        .WithOne("ProjectAffiliation")
                        .HasForeignKey("Mosaico.Domain.ProjectManagement.Entities.Affiliation.ProjectAffiliation", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.AirdropParticipant", b =>
                {
                    b.HasOne("Mosaico.Domain.ProjectManagement.Entities.AirdropCampaign", "AirdropCampaign")
                        .WithMany("Participants")
                        .HasForeignKey("AirdropCampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AirdropCampaign");
                });
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.TokenPage.PagePartners", b =>
                {
                    b.HasOne("Mosaico.Domain.ProjectManagement.Entities.TokenPage.Page", "Page")
                        .WithMany("PagePartners")
                        .HasForeignKey("PageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mosaico.Domain.ProjectManagement.Entities.Project", null)
                        .WithMany("PagePartners")
                        .HasForeignKey("ProjectId");
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.Affiliation.Partner", b =>
                {
                    b.Navigation("PartnerTransactions");
                });
            ...
            modelBuilder.Entity("Mosaico.Domain.ProjectManagement.Entities.TokenPage.Page", b =>
                {
                    ...
                    b.Navigation("PageIntroVideos");

                    b.Navigation("PagePartners");

                    b.Navigation("PageReviews");

...
namespace Mosaico.Persistence.SqlServer.Migrations.Wallet
{
    ...
    [Migration("20220525113053_AddedVestingDepositTransactionTracking")]
    partial class AddedVestingDepositTransactionTracking
    {
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.WalletToVesting", b =>
                {
                    ...
                    b.HasOne("Mosaico.Domain.Wallet.Entities.Wallet", null)
                        .WithMany("Vestings")

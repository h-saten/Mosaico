...
namespace Mosaico.Persistence.SqlServer.Migrations.Wallet
{
    ...
    [Migration("20220424202258_UpdatedPrecisionOfTheExchangeRate")]
    partial class UpdatedPrecisionOfTheExchangeRate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.VestingFund", b =>
                {
                    ...
                    b.Property<Guid?>("TokenDistributionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TokenDistributionId")
                        .IsUnique()
                        .HasFilter("[TokenDistributionId] IS NOT NULL");
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.Vesting", b =>
                {
                    b.HasOne("Mosaico.Domain.Wallet.Entities.Token", "Token")
                        .WithOne("Vesting")
                        .HasForeignKey("Mosaico.Domain.Wallet.Entities.Vesting", "TokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.VestingFund", b =>
                {
                    b.HasOne("Mosaico.Domain.Wallet.Entities.TokenDistribution", "TokenDistribution")
                        .WithOne()
                        .HasForeignKey("Mosaico.Domain.Wallet.Entities.VestingFund", "TokenDistributionId");
                    ...
                    b.Navigation("TokenDistribution");

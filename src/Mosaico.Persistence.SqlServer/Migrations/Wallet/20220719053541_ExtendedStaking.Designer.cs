...
namespace Mosaico.Persistence.SqlServer.Migrations.Wallet
{
    ...
    [Migration("20220719053541_ExtendedStaking")]
    partial class ExtendedStaking
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.Staking.StakingPair", b =>
                {
                    ...
                    b.Property<Guid?>("StakingTermsId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.Staking.StakingRegulation", b =>
                {
                    ...
                    b.ToTable("StakingRegulations", "wlt");
                });
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.Staking.StakingRegulationTranslation", b =>
                {
                    ...
                    b.ToTable("StakingRegulationTranslations", "wlt");
                });

            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.Staking.StakingTerms", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("StakingTerms", "wlt");
                });

            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.Staking.StakingTermsTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("StakingTermsTranslations", "wlt");
                });
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.Staking.StakingRegulation", b =>
                {
                    b.HasOne("Mosaico.Domain.Wallet.Entities.Staking.StakingPair", "StakingPair")
                        .WithOne("StakingRegulation")
                        .HasForeignKey("Mosaico.Domain.Wallet.Entities.Staking.StakingRegulation", "StakingPairId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.Staking.StakingTerms", b =>
                {
                    b.HasOne("Mosaico.Domain.Wallet.Entities.Staking.StakingPair", "StakingPair")
                        .WithOne("StakingTerms")
                        .HasForeignKey("Mosaico.Domain.Wallet.Entities.Staking.StakingTerms", "StakingPairId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Mosaico.Domain.Wallet.Entities.Staking.StakingTermsTranslation", b =>
                {
                    b.HasOne("Mosaico.Domain.Wallet.Entities.Staking.StakingTerms", "StakingTerms")
                        .WithMany("Translations")
                        .HasForeignKey("EntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StakingTerms");
                });

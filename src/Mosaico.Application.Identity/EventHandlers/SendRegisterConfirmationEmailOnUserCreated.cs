...
{
    [EventInfo(nameof(SendRegisterConfirmationEmailOnUserCreated),  "users:id")]
    [EventTypeFilter(typeof(UserCreatedEvent))]
    public class SendRegisterConfirmationEmailOnUserCreated : EventHandlerBase
    {
        ...
        public SendRegisterConfirmationEmailOnUserCreated(IIdentityContext identityContext, IIdentityEmailService emailService, UserManager<ApplicationUser> userManager, IIndex<string, string> urls, ILogger logger = null)
        {
        ...
        public override async Task HandleAsync(CloudEvent @event)
        {
            ...
            if (userEvent != null)
            {
                ...
                if (user != null)
                {
                    ...
                    await _emailService.SendEmailConfirmationEmailAsync(user, callbackUrl, user.Language);
                }
                else

...
{
    public class DurableServiceBusEventPublisher : ServiceBusPublisher
    {
        private readonly ISystemEventFactory _systemEventFactory;
        private readonly IEventRepository _eventRepository;
        
        public DurableServiceBusEventPublisher(IBus provider, ISystemEventFactory systemEventFactory, IEventRepository eventRepository, ILogger logger = null) : base(provider, logger)
        {
